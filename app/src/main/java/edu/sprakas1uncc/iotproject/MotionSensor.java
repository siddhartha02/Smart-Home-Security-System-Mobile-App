 ...
 */
public class MotionSensor extends Fragment {
    public static String main_sensor_status = "INACTIVE";
    public static String upstair_sensor_status = "INACTIVE";
        ...
        toggle1.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if (isChecked) {
                    // The toggle is enabled
                    Log.d("toggle button","Button is ON");
                    upstair_sensor_status= "ACTIVE";
                    setUpstairData(upstair_sensor_status);
                } else {
                    // The toggle is disabled
                    Log.d("toggle button", "Button is OFF");
                    upstair_sensor_status= "INACTIVE";
                    setUpstairData(upstair_sensor_status);
                }
            }
        });
